...
public class PageUtil {
    ...
    public static Pageable initPage(PageVo page){
        ...
        if(!LypNullUtils.isNull(sort)) {
            Sort.Direction direction = LypNullUtils.isNull(order) ? Sort.Direction.DESC : Sort.Direction.valueOf(order.toUpperCase());
    ...
    public static String camel2Underline(String underlineContent) {
        if (LypNullUtils.isNull(underlineContent)) {
            return NULL_STR;
        }
