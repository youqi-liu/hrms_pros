package cn.lyp.basics.security.validate;

import cn.lyp.basics.utils.ResponseUtil;
import cn.lyp.basics.parameter.CaptchaProperties;
...
public class ImageValidateFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if(LypNullUtils.isNull(userInputCode) || LypNullUtils.isNull(verificationCodeId)){
        ...
        if(LypNullUtils.isNull(codeAnsInRedis)){
