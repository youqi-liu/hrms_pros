            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="title">
                        <Input type="text" v-model="searchForm.title" placeholder="请输入职称名称" clearable style="width: 200px" />
                    </Form-item>
                    <Form-item label="" prop="code">
                        <Input type="text" v-model="searchForm.code" placeholder="请输入职称代码" clearable style="width: 200px" />
                    </Form-item>
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getJobTitleList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
