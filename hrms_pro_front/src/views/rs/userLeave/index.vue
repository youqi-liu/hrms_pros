        ...
        <Row v-show="openSearch" @keydown.enter.native="handleSearch">
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="leaveDate">
                        <DatePicker type="date" v-model="searchForm.leaveDate" placeholder="请假日期" clearable style="width: 200px"></DatePicker>
                    </Form-item>
                    <Form-item label="" prop="leaveReason">
                        <Input type="text" v-model="searchForm.leaveReason" placeholder="请假理由" clearable style="width: 200px" />
                    </Form-item>
                    <Form-item label="" prop="status">
                        <Select v-model="searchForm.status" placeholder="请假状态" clearable style="width: 200px">
                    ...
                    <Form-item style="margin-left:10px;" class="br">
                        ...
                        <Button @click="add" type="info" size="small" icon="md-add" ghost>员工请假</Button>
                        <Button @click="delAll" type="error" icon="md-trash" size="small" ghost>删除请假</Button>
...
export default {
                            ...
                            h(
                                "Button", {
                                    props: {
                                        ...
                                        ghost: true,
                                        ghost: true,
                                        disabled: (params.row.status != '未审核')
                                    },
                                    style: {
                                        marginRight: "5px"
                                    },
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getUserLeaveList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
