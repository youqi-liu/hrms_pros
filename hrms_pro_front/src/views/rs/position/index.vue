            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="title">
                        <Input type="text" v-model="searchForm.title" placeholder="请输入职位名称" clearable style="width: 200px" />
                    </Form-item>
                    <Form-item label="" prop="code">
                        <Input type="text" v-model="searchForm.code" placeholder="请输入职位代码" clearable style="width: 200px" />
                    </Form-item>
                    <Form-item style="margin-left:10px;" class="br">
                        <Button @click="handleSearch" type="primary" icon="ios-search" size="small"></Button>
                        <Button @click="handleReset" type="warning" size="small" icon="md-refresh"></Button>
                        <Button @click="add" type="info" size="small" icon="md-add"></Button>
                        <Button @click="delAll" type="error" icon="md-trash" size="small"></Button>
                        <Button @click="excelData" type="success" icon="md-paper-plane" size="small"></Button>
                    </Form-item>
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getPositionList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
