...
<div class="search">
    ...
    <Drawer title="文件上传" closable v-model="uploadVisible" width="500">
        <Upload action="/api/v1/upload/file" :headers="accessToken" :on-success="handleSuccess" :on-error="handleError" :max-size="5120" :on-exceeded-size="handleMaxSize" :before-upload="beforeUpload" multiple type="drag" ref="up">
    ...
    <Modal title="文件存储配置" v-model="fileSaveSettingModal" :mask-closable="false" :width="700" ok-text="保存" @on-ok="setFileSettingFx">
        <Form ref="settingForm" :model="settingForm" :label-width="95">
            ...
            <Row :gutter="16">
                <Col span="24">
                <FormItem label="预览接口">
                    <Input type="text" v-model="fileView" placeholder="如127.0.0.1:8080/api/v1/file/view" style="width: 100%">
