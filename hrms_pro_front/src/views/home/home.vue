...
<div :style="{ height: clientHeight }" class="topDiv">
    <Row :gutter="20">
        ...
        <div class="body">
            <!--logo标题图片 -->
            <div class="logo-home" style="display: flex; align-items: center; justify-content: center; margin: 5vh 0;">
                <Icon type="ios-people" size="60" style="color: #ff6f00; margin-right: 15px;"/>
                <span style="font-size: 28px; font-weight: bold; color: #333;">HRMS Pro</span>
            </div>
            <!--第二排内容 -->
            <div class="awayMenu">
                <!--左侧 -->
